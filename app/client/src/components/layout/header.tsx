...
export function Header() {
  ...
  return (
    <header role="banner" className="flex h-[var(--header-height)] items-center justify-between border-b border-border bg-card px-4">
      {/* Search bar */}
      <div className="relative flex-1 max-w-md" role="search">
        ...
        <input
          ...
          aria-label="Search entities, KPIs, or ask a question"
